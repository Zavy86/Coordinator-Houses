 ...
 */
 ...
 if($house_obj->id){
  ...
  if(!$house_obj->deleted){
   $form->addControl("button",api_text("form-fc-delete"),api_url(["scr"=>"submit","act"=>"house_delete","idHouse"=>$house_obj->id]),"btn-danger",api_text("houses_edit-fc-delete-confirm"));
  }else{
   ...
   $form->addControl("button",api_text("form-fc-remove"),api_url(["scr"=>"submit","act"=>"house_remove","idHouse"=>$house_obj->id]),"btn-danger",api_text("houses_edit-fc-remove-confirm"));
  }
